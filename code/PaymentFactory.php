...
use payment\PaymentProcessor_GatewayHosted;
...
class PaymentFactory {
	...
	public static function get_gateway($methodName) {
		...
		$gatewayClass = "payment\\$gatewayClass";
		...
		if (class_exists($gatewayClass)) {
			...
			throw new Exception("$gatewayClass class does not exist.");
		}
	}
	...
	public static function factory($methodName) {
		...
		if (isset($methodConfig['processor'])) {
			...
			$processorClass = 'payment\\' . $processorClass;
